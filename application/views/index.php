...
<head>
	<title>PT Brilliant Jaya Wood Industry</title>
	<meta charset="utf-8">
...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
	...
	<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light site-navbar-target"
		id="ftco-navbar">
		<div class="container">
			<a class="navbar-brand" href="index.html">Brilliant Jaya<span> Wood Industry</span></a>
			...
			<div class="collapse navbar-collapse" id="ftco-nav">
				<ul class="navbar-nav nav ml-auto">
					...
					<li class="nav-item"><a href="#about-section" class="nav-link"
							style="color:white;"><span>About</span></a></li>
					<li class="nav-item"><a href="#blog-section" class="nav-link"
							style="color:white;"><span>Blog</span></a></li>
					<li class="nav-item"><a href="#testimony-section" class="nav-link"
							style="color:white;"><span>Career</span></a></li>
					<li class="nav-item"><a href="#contact-section" class="nav-link"
							style="color:white;"><span>Contact</span></a></li>
				</ul>
			</div>
		</div>
	</nav>
	<section id="home-section" class="hero">
		<h3 class="vr">Welcome to BJWI</h3>
				...
				<div class="container-fluid p-0">
					<div class="row d-md-flex no-gutters slider-text js-fullheight align-items-center justify-content-end"
						...
						<div class="one-forth d-flex js-fullheight align-items-center ftco-animate"
							...
							<div class="text">
								<span class="subheading">Welcome to the BJWI</span>
								<h1 class="mb-4 mt-3"><span>Star</span> is Highest Rating</h1>
								<p>Considered to be the most environmentally friendly health standard in the world.</p>

								<p><a href="#about-section" class="btn btn-primary px-5 py-3 mt-3">This is Our</a></p>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="container-fluid p-0">
					<div class="row d-flex no-gutters slider-text js-fullheight align-items-center justify-content-end"
						...
						<div class="one-forth d-flex js-fullheight align-items-center ftco-animate"
							...
							<div class="text">
								<span class="subheading">Welcome to the BJWI</span>
								<h1 class="mb-4 mt-3"><span>Best</span> Solid Wood Door Factory</h1>
								<p>Product sell well all over the world and leading the export for nine consecutive
									years.</p>

								<p><a href="#production-section" class="btn btn-primary px-5 py-3 mt-3">Our Product</a>
								</p>
							</div>
						</div>
					</div>
	...
	<section class="ftco-section ftco-no-pb ftco-no-pt ftco-services bg-light" id="company-section">
		<!-- <div class="container">
	...
	<section class="ftco-section ftco-project bg-light" id="production-section">
		<div class="container px-md-5">
			<div class="row justify-content-center pb-5">
				<div class="col-md-12 heading-section text-center ftco-animate">
					<h2 class="mb-4">Production</h2>
					<p>All Over The World, All Homes Are Friends</p>
				</div>
			</div>
			<div class="row">
				<div class="col-md-12 testimonial">
					<div class="carousel-project owl-carousel">
						<div class="item">
							<div class="project">
								<div class="img">
									<img src="assets/images/project-1.jpg" class="img-fluid" alt="Colorlib Template">
									<div class="text px-4">
										<h3><a href="#">BJWI Production</a></h3>
									</div>
								</div>
							</div>
						</div>
						<div class="item">
							<div class="project">
								<div class="img">
									<img src="assets/images/project-2.jpg" class="img-fluid" alt="Colorlib Template">
									<div class="text px-4">
										<h3><a href="#">BJWI Production</a></h3>
									</div>
								</div>
						...
						<div class="item">
							<div class="project">
								<div class="img">
									<img src="assets/images/project-3.jpg" class="img-fluid" alt="Colorlib Template">
									<div class="text px-4">
										<h3><a href="#">BJWI Production</a></h3>
									</div>
								</div>
						...
						<div class="item">
							<div class="project">
								<div class="img">
									<img src="assets/images/project-4.jpg" class="img-fluid" alt="Colorlib Template">
									<div class="text px-4">
										<h3><a href="#">BJWI Production</a></h3>
									</div>
								</div>
						...
						<div class="item">
							<div class="project">
								<div class="img">
									<img src="assets/images/project-5.jpg" class="img-fluid" alt="Colorlib Template">
									<div class="text px-4">
										<h3><a href="#">BJWI Production</a></h3>
									</div>
								</div>
						...
						<div class="item">
							<div class="project">
								<div class="img">
									<img src="assets/images/project-6.jpg" class="img-fluid" alt="Colorlib Template">
									<div class="text px-4">
										<h3><a href="#">BJWI Production</a></h3>
									</div>
								</div>
			...
			<div class="row d-flex">
				<div class="col-md-6 col-lg-5 d-flex">
					<div class="img d-flex align-self-stretch align-items-center"
						style="background-image:url(assets/images/about.png);">
					</div>
				</div>
					...
					<div class="py-md-5">
						<div class="row justify-content-start pb-3">
							<div class="col-md-12 heading-section ftco-animate">
								<span class="subheading">Welcome to BJWI</span>
								<h2 class="mb-4" style="font-size: 34px; text-transform: capitalize;">We Are Brilliant
									Jaya Wood Industry</h2>
								<p>Our company PT. BRILLIANT JAYA WOOD INDUSTRY is the company which specializes in wood
									industry. It is a new company established in Gresik,East Java,Indonesia By SY Group
									in China.</p>
								<p>SY Group is founded in 2002, located in Dalian, China. It covers an area of ​​200,000
									square meters and has more than 1,000 employees. It is a collection of wood products
									research and development, design, production and processing, and after-sales
									service, large wood products manufacturing company.</p>
								<p>The solid wood door products produced by the company have been exported to more than
									20 countries and regions in the world, with an annual export volume of 1 million
									fans. In nine consecutive years, the company has ranked first in the export volume
									of solid wood doors in China. The products have been well received by domestic and
									foreign customers. </p>
							</div>
						</div>
					...
					<div class="blog-entry justify-content-end">
						...
						<div class="text mt-3 float-right d-block">
							...
							<div class="d-flex align-items-center mt-4 meta">
								<p class="mb-0"><a href="<?= base_url('Home/post1'); ?>" class="btn btn-primary">Read More <span
			...
			<div class="row d-flex contact-info mb-5">
				<div class="col-md-6 col-lg-3 d-flex ftco-animate">
					<div class="align-self-stretch box p-4 text-center">
						...
						<p>KPP 100, Mayjend Sungkono Street No.100, Kebomas, Gresik City, East Java 61124</p>
					</div>
				</div>
				<div class="col-md-6 col-lg-3 d-flex ftco-animate">
					<div class="align-self-stretch box p-4 text-center">
						...
						<p><a href="tel://03199102288">+6231 9910 2288</a></p>
					</div>
				</div>
				<div class="col-md-6 col-lg-3 d-flex ftco-animate">
					<div class="align-self-stretch box p-4 text-center">
						...
						<p><a href="mailto:hello@bjwi.co.id">hello@bjwi.co.id</a></p>
					</div>
				</div>
				<div class="col-md-6 col-lg-3 d-flex ftco-animate">
					<div class="align-self-stretch box p-4 text-center">
						...
						<h3 class="mb-4">Official Website</h3>
						<p><a href="https://bjwi.co.id">www.bjwi.co.id</a></p>
					</div>
				</div>
			</div>
			...
			<div class="row mb-5">
				<div class="col-md">
					<div class="ftco-footer-widget mb-4">
						<h2 class="ftco-heading-2">About BJWI</h2>
						<p>Our company PT Brilliant Jaya Wood Industry is the company which specializes in wood
							industry. It is a new company established in Gresik,East Java,Indonesia By SY Group in
							China.</p>
				...
				<div class="col-md">
					<div class="ftco-footer-widget mb-4 ml-md-4">
						...
						<ul class="list-unstyled">
							...
							<li><a href="#career-section"><span class="icon-long-arrow-right mr-2"></span>Career</a>
							</li>
				...
				<div class="col-md">
					<div class="ftco-footer-widget mb-4">
						...
						<div class="block-23 mb-3">
							<ul>
								<li><span class="icon icon-map-marker"></span><span class="text">KPP 100, Mayjend
										Sungkono Street No.100, Kebomas, Gresik City, East Java 61124</span></li>
								<li><a href="#"><span class="icon icon-phone"></span><span class="text">+6231 9910
											2288</span></a></li>
								<li><a href="#"><span class="icon icon-envelope"></span><span
											class="text">hello@bjwi.co.id</span></a></li>
							</ul>
						</div>
					</div>
				</div>
				...
				<div class="col-md-12 text-center">
					...
					<p>
						...
						<script>document.write(new Date().getFullYear());</script> All rights reserved <a
							href="https://bjwi.co.id" target="_blank">| PT Brilliant Jaya Wood Industry</a>
						<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
					</p>
				</div>
			</div>
